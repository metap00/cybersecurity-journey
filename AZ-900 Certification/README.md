...
Studying for the AZ-900 certification to build foundational cloud knowledge
as part of my long-term path toward cloud security (AZ-500).

## Exam Domains

### 1. Cloud Concepts (25-30%)
- Cloud computing benefits, service types, deployment models
- [Notes coming as I study]
...
- Cost management, governance, compliance, tools
- [Notes coming as I study]

## Study Resources
- Microsoft Learn free modules (official)
